...
PhaseDetectJPEditor::PhaseDetectJPEditor(GenericProcessor* parentNode, bool useDefaultParameterEditors = true)
...
PhaseDetectJPEditor::~PhaseDetectJPEditor()
{

}

void PhaseDetectJPEditor::updateSettings()
{
...
void PhaseDetectJPEditor::comboBoxChanged(ComboBox* c)
{
...
void PhaseDetectJPEditor::buttonEvent(Button* button)
{
...
void PhaseDetectJPEditor::addDetector()
{
	std::cout << "Adding detector" << std::endl;

	PhaseDetectJP* pd = (PhaseDetectJP*)getProcessor();

	int detectorNumber = interfaces.size() + 1;

	DetectorInterfaceJP* di = new DetectorInterfaceJP(pd, backgroundColours[detectorNumber % 5], detectorNumber - 1);
...
void PhaseDetectJPEditor::saveCustomParameters(XmlElement* xml)
{

	xml->setAttribute("Type", "PhaseDetectJPEditor");
...
void PhaseDetectJPEditor::loadCustomParameters(XmlElement* xml)
{
...
DetectorInterfaceJP::DetectorInterfaceJP(PhaseDetectJP* pd, Colour c, int id) :
...
DetectorInterfaceJP::~DetectorInterfaceJP()
{

}

void DetectorInterfaceJP::comboBoxChanged(ComboBox* c)
{
...
void DetectorInterfaceJP::buttonClicked(Button* b)
{
...
void DetectorInterfaceJP::updateChannels(int numChannels)
{
...
void DetectorInterfaceJP::paint(Graphics& g)
{
...
int DetectorInterfaceJP::getPhase()
{
...
void DetectorInterfaceJP::setPhase(int p)
{
...
void DetectorInterfaceJP::setInputChan(int chan)
{
...
void DetectorInterfaceJP::setOutputChan(int chan)
{
...
void DetectorInterfaceJP::setGateChan(int chan)
{
...
int DetectorInterfaceJP::getInputChan()
{
	return inputSelector->getSelectedId() - 2;
}

int DetectorInterfaceJP::getOutputChan()
{
	return outputSelector->getSelectedId() - 2;
}

int DetectorInterfaceJP::getGateChan()
{
